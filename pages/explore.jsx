...
import ExploreSidebar from '../components/exploreComps/ExploreSidebar'
import exploreStyles from '../styles/pageStyles/exploreStyles'
		...
		<>
			...
			<div style={{ marginBottom: "2rem" }}>
					...
					<div className="welcome__div">
							...
							<p>Vendor management made easy.</p>
					</div>


				<div className='explore__bodyTop'>
						<div className='explore__sidebar'>
								<ExploreSidebar username={user?.name} id={user?._id}/>
						</div>
				...
				<div className='explore__postBody'
				style={{
